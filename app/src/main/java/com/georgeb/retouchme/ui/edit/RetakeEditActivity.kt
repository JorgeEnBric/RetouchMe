...
import com.georgeb.retouchme.databinding.ActivityRetakeEditBinding
import com.georgeb.retouchme.face.FaceAdjustments
import com.georgeb.retouchme.face.FaceMaskBuilder
import com.georgeb.retouchme.face.MediaPipeFaceMeshHelper
...
class RetakeEditActivity : AppCompatActivity() {
    ...
    private fun getFaceMatrix(auto: com.georgeb.retouchme.face.AutoRetakeResult): android.graphics.Matrix {
    ...
    private fun selectTool(tool: Tool) {
        ...
        when (tool) {
            Tool.ZOOM -> {
                binding.textActiveTool.setText(com.georgeb.retouchme.R.string.tool_basic)
            ...
            Tool.POSITION -> {
                binding.textActiveTool.setText(com.georgeb.retouchme.R.string.tool_position)
            ...
            Tool.HALO -> {
                binding.textActiveTool.setText(com.georgeb.retouchme.R.string.tool_halo)
            ...
            Tool.TONE -> {
                binding.textActiveTool.setText(com.georgeb.retouchme.R.string.tool_tone)
            ...
            Tool.FRAME_EXPAND -> {
                binding.textActiveTool.setText(com.georgeb.retouchme.R.string.tool_frame_expand)
    ...
    private fun applyAndSave() {
        ...
        lifecycleScope.launch {
            ...
            Toast.makeText(this@RetakeEditActivity, com.georgeb.retouchme.R.string.image_saved_toast, Toast.LENGTH_SHORT).show()
