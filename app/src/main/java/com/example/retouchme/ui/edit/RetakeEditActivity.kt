...
import com.example.retouchme.databinding.ActivityRetakeEditBinding
import com.example.retouchme.face.FaceAdjustments
import com.example.retouchme.face.FaceMaskBuilder
import com.example.retouchme.face.MediaPipeFaceMeshHelper
import com.example.retouchme.face.PostProcessAdjustments
import com.example.retouchme.face.PostProcessEngine
...
class RetakeEditActivity : AppCompatActivity() {
    ...
    private fun getFaceMatrix(auto: com.example.retouchme.face.AutoRetakeResult): android.graphics.Matrix {
    ...
    private fun selectTool(tool: Tool) {
        ...
        when (tool) {
            Tool.ZOOM -> {
                binding.textActiveTool.setText(com.example.retouchme.R.string.tool_basic)
            ...
            Tool.POSITION -> {
                binding.textActiveTool.setText(com.example.retouchme.R.string.tool_position)
            ...
            Tool.HALO -> {
                binding.textActiveTool.setText(com.example.retouchme.R.string.tool_halo)
            ...
            Tool.TONE -> {
                binding.textActiveTool.setText(com.example.retouchme.R.string.tool_tone)
            ...
            Tool.FRAME_EXPAND -> {
                binding.textActiveTool.setText(com.example.retouchme.R.string.tool_frame_expand)
    ...
    private fun applyAndSave() {
        ...
        lifecycleScope.launch {
            ...
            Toast.makeText(this@RetakeEditActivity, com.example.retouchme.R.string.image_saved_toast, Toast.LENGTH_SHORT).show()
