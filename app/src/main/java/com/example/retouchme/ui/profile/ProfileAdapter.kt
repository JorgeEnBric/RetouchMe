...
import com.example.retouchme.databinding.ItemProfileBinding
...
class ProfileAdapter(
    ...
    private val onRemoveFace: (FaceProfileWithImages, com.example.retouchme.data.FaceImageEntity) -> Unit
